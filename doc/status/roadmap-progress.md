...
| Exact explicit rejected JDK callables | 1391 | Deterministic callable-member rejects currently counted exactly from forbidden APIs plus verifier-backed monitor/concurrency members. |
| Exact done JDK callables | 2354/267886 (0.8%) | Lower-bound supported-plus-explicitly-rejected callable-member accounting on the scanned JDK 25 image for the clean committed branch baseline. |
| Exact unknown JDK callables | 265532 | Callable members on the scanned JDK 25 image not yet counted as supported or explicitly rejected. |
