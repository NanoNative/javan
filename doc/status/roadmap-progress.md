...
| Exact supported JDK callables | 985/267886 (0.3%) | Lower-bound callable-member coverage on the scanned JDK 25 image for members that already match the exact native support registry on the current branch baseline. |
...
| Exact done JDK callables | 6020/267886 (2.2%) | Lower-bound supported-plus-explicitly-rejected callable-member accounting on the scanned JDK 25 image for the current branch baseline. |
| Exact unknown JDK callables | 261866 | Callable members on the scanned JDK 25 image not yet counted as supported or explicitly rejected. |
| Exact supported JDK callables left | 266901 | Callables on the scanned JDK 25 image that are not yet in the exact supported callable ledger. |
