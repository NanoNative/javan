...
| exact explicit rejected JDK callables | 5679 |
| exact done JDK callables | 6711 / 267886 (2.5%) |
| exact unknown JDK callables | 261175 |
...
`ConditionalSpecialCasing` and `String$CaseInsensitiveComparator` owners.
