...
| exact explicit rejected JDK callables | 10820 |
| exact done JDK callables | 11852 / 267886 (4.4%) |
| exact unknown JDK callables | 256034 |
...
full `java.util.zip.*` owner namespace.
