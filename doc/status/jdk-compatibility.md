...
| exact explicit rejected JDK callables | 11868 |
| exact done JDK callables | 12900 / 267886 (4.8%) |
| exact unknown JDK callables | 254986 |
...
full `java.nio.charset.*` owner namespace.
