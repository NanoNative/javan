...
| exact explicit rejected JDK callables | 19147 |
| exact done JDK callables | 20179 / 267886 (7.5%) |
| exact unknown JDK callables | 247707 |
...
full `java.time.chrono.*` owner namespace.
