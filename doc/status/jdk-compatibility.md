...
| exact explicit rejected JDK callables | 5102 |
| exact done JDK callables | 6134 / 267886 (2.2%) |
| exact unknown JDK callables | 261752 |
...
current `StringBuilder` char-sequence/string-buffer/code-point/stream/repeat family.
