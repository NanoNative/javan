...
| exact explicit rejected JDK callables | 9355 |
| exact done JDK callables | 10387 / 267886 (3.8%) |
| exact unknown JDK callables | 257499 |
...
full `java.util.stream.*` owner namespace.
