...
| exact explicit rejected JDK callables | 6261 |
| exact done JDK callables | 7293 / 267886 (2.7%) |
| exact unknown JDK callables | 260593 |
...
full `java.util.function.*` owner namespace.
