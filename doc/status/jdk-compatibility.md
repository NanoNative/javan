...
| exact explicit rejected JDK callables | 6145 |
| exact done JDK callables | 7177 / 267886 (2.6%) |
| exact unknown JDK callables | 260709 |
...
full `java.util.regex.*` owner namespace.
