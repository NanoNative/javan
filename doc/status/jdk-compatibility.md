...
| exact explicit rejected JDK callables | 19546 |
| exact done JDK callables | 20578 / 267886 (7.6%) |
| exact unknown JDK callables | 247308 |
...
full `java.security.cert.*` owner namespace except platform-throwable owners.
