...
| exact explicit rejected JDK callables | 11253 |
| exact done JDK callables | 12285 / 267886 (4.5%) |
| exact unknown JDK callables | 255601 |
...
full `java.time.format.*` owner namespace.
