...
- broader service runtime coverage, especially multiple `HttpServer` contexts, `HttpContext` accessors, request headers/bodies, executor-backed handlers, `HttpHandler` lambdas, HTTPS/TLS, certificates, and resource-heavy app packaging
