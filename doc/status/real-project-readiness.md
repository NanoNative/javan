...
- materialized custom functional-interface lambdas, default-method dispatch through custom SAMs, and dynamic-call sites beyond the current exact `Function`/`Predicate` bridge
