...
final class RuntimeHeaderFile {
    private static final String CONTENT = """
        ...
        void javan_http_server_run(void* server);
        ...
        void javan_http_exchange_output_stream_write_bytes_range(void* stream, void* bytes, int offset, int length);
        void javan_http_exchange_output_stream_flush(void* stream);
        void javan_http_exchange_output_stream_close(void* stream);
