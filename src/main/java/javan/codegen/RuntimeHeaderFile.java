...
final class RuntimeHeaderFile {
    private static final String CONTENT = """
        ...
        void* javan_list_reversed(void* list);
        ...
        void* javan_map_put_first(void* map, void* key, void* value);
        void* javan_map_put_last(void* map, void* key, void* value);
        ...
        int javan_socket_input_stream_read_chunked_bytes(void* stream, signed char* destination, int length);
        ...
        int javan_resource_input_stream_read_n_bytes_into(void* value, void* bytes, int offset, int length);
        ...
        void javan_http_server_remove_context(void* server, void* path);
        ...
        void* javan_http_exchange_request_method(void* exchange);
        void* javan_http_exchange_request_uri(void* exchange);
        void* javan_http_exchange_remote_address(void* exchange);
        void* javan_http_exchange_local_address(void* exchange);
        int javan_http_exchange_response_code(void* exchange);
        void* javan_http_exchange_protocol(void* exchange);
        void* javan_http_exchange_request_headers(void* exchange);
        void* javan_http_headers_get_first(void* headers, void* name);
        void* javan_http_headers_get(void* headers, void* name);
        void* javan_http_headers_get_or_default(void* headers, void* name, void* default_value);
        ...
        void* javan_map_entry_set_value(void* entry, void* value);
        int javan_http_headers_contains_key(void* headers, void* name);
        void* javan_http_headers_remove(void* headers, void* name);
        int javan_http_headers_remove_entry(void* headers, void* name, void* expected_values);
        void javan_http_headers_clear(void* headers);
        int javan_http_headers_size(void* headers);
        int javan_http_headers_is_empty(void* headers);
        void* javan_http_headers_put(void* headers, void* name, void* values);
        void* javan_http_headers_replace(void* headers, void* name, void* values);
        int javan_http_headers_replace_entry(void* headers, void* name, void* expected_values, void* values);
        void* javan_http_headers_put_if_absent(void* headers, void* name, void* values);
        int javan_http_headers_contains_value(void* headers, void* candidate);
        void javan_http_headers_put_all(void* headers, void* source);
        void* javan_http_exchange_response_headers(void* exchange);
        void javan_http_headers_set(void* headers, void* name, void* header_value);
        void javan_http_headers_add(void* headers, void* name, void* header_value);
        void* javan_http_exchange_request_body(void* exchange);
