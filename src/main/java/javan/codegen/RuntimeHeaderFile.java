...
final class RuntimeHeaderFile {
    private static final String CONTENT = """
        ...
        void javan_throwable_set_message(void* throwable, void* message);
        void* javan_throwable_get_message(void* throwable);
        void javan_throwable_add_suppressed(void* throwable, void* suppressed);
        void* javan_throwable_get_suppressed(void* throwable);
        void* javan_throwable_get_stack_trace(void* throwable);
        void javan_throwable_set_stack_trace(void* throwable, void* stack_trace);
        ...
        typedef struct {
            ...
            const char* name;
            int is_enum;
            int assignable_name_count;
            const char** assignable_names;
        ...
        void* javan_set_to_array(void* set);
        ...
        void javan_map_put_all(void* target, void* source);
        ...
        int javan_http_input_stream_read_bytes(void* value, void* bytes);
        int javan_http_input_stream_read_bytes_range(void* value, void* bytes, int offset, int length);
        void javan_http_input_stream_close(void* value);
        void javan_http_output_stream_write(void* value, int byte_value);
        void javan_http_output_stream_write_bytes(void* value, void* bytes);
        void javan_http_output_stream_write_bytes_range(void* value, void* bytes, int offset, int length);
        ...
        void* javan_string_format_exact(void* format, void* args);
