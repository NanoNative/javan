...
public final class CompatibilityReports {
    ...
    private static List<SupportRow> supportRows() {
        return List.of(
            ...
            pass("management-runtime-module-rejection"),
            pass("management-runtime-memory-processors"),
            pass("management-thread-runtime-mxbeans"),
            pass("management-memory-mxbean"),
            pass("management-operating-system-mxbean"),
            pass("process-handle-current-pid"),
