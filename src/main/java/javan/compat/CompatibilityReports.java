...
public final class CompatibilityReports {
    ...
    private static List<SupportRow> supportRows() {
        return List.of(
            ...
            pass("try-catch"),
            pass("application-runtime-exception-transport"),
            scoped("try-finally"),
            pass("enum-basic"),
            pass("enum-ordinal"),
            pass("enum-values"),
            ...
            pass("resource-dependency-jar"),
            pass("resource-sha256-evidence"),
            pass("resource-library-stream"),
            pass("resource-url-rejection"),
            ...
            pass("collection-remove-all"),
            pass("collection-retain-all"),
            pass("collection-remove-if"),
            pass("collection-contains-all"),
            pass("collection-remove"),
            pass("collection-clear"),
            pass("abstractlist-direct-owner-add"),
            pass("abstractlist-direct-owner-clear"),
            pass("abstractlist-direct-owner-indexed-surface"),
            pass("abstractlist-direct-owner-index-of"),
            pass("abstractlist-direct-owner-iterator"),
            pass("abstractlist-direct-owner-list-iterator"),
            pass("abstractlist-direct-owner-last-index-of"),
            pass("list-add-all-at"),
            pass("list-index-of"),
            pass("list-last-index-of"),
            pass("list-list-iterator-at"),
            pass("list-remove-object"),
            pass("list-remove-at"),
            pass("list-remove-all"),
            pass("list-retain-all"),
            pass("list-contains-all"),
            pass("listiterator-previous"),
            pass("listiterator-indexes"),
            pass("listiterator-set"),
            pass("listiterator-add"),
            pass("listiterator-remove"),
            pass("set-add-all"),
            pass("set-remove-all"),
            pass("set-retain-all"),
            ...
            pass("arraylist-direct-owner-get-first"),
            pass("arraylist-direct-owner-get-last"),
            pass("arraylist-direct-owner-add-all-at"),
            pass("arraylist-direct-owner-index-of"),
            pass("arraylist-direct-owner-last-index-of"),
            pass("arraylist-direct-owner-remove-object"),
            pass("arraylist-direct-owner-set"),
            pass("arraylist-direct-owner-remove-at"),
            pass("arraylist-direct-owner-remove-last"),
            pass("arraylist-direct-owner-add-first"),
            pass("arraylist-direct-owner-add-last"),
            ...
            pass("hashset-direct-owner-retain-all"),
            pass("hashset-direct-owner-remove"),
            pass("hashset-direct-owner-clear"),
            pass("linkedhashset-direct-owner-read-surface"),
            pass("linkedhashset-direct-owner-add-all"),
            pass("linkedhashset-direct-owner-remove-all"),
            pass("linkedhashset-direct-owner-retain-all"),
            pass("linkedhashset-direct-owner-remove"),
            pass("linkedhashset-direct-owner-clear"),
            pass("hashmap-capacity-constructor"),
            pass("linkedhashmap-capacity-constructor"),
            pass("hashmap-load-factor-constructor"),
            pass("linkedhashmap-load-factor-constructor"),
            pass("hashmap-map-constructor"),
            pass("linkedhashmap-map-constructor"),
            pass("hashmap-static-factory"),
            pass("linkedhashmap-static-factory"),
            ...
            pass("network-inetaddress-byte-address"),
            pass("network-inetaddress-named-byte-address"),
            pass("network-tcp-client-socket"),
            pass("network-tcp-client-socket-ipv6-loopback"),
            pass("network-tcp-client-socket-address"),
            pass("network-tcp-client-socket-local-bind"),
            ...
            pass("network-tcp-server-socket-reuse-address"),
            pass("network-tcp-socket-local-address"),
            ...
            pass("network-tcp-socket-receive-buffer"),
            pass("network-tcp-socket-send-buffer"),
            pass("network-tcp-socket-so-linger"),
            pass("network-tcp-socket-oob-inline"),
            pass("network-tcp-socket-traffic-class"),
            pass("network-tcp-socket-bound-state"),
            pass("network-tcp-socket-input-shutdown-state"),
            pass("network-tcp-socket-output-shutdown-state"),
            pass("network-tcp-socket-timeout-round-trip"),
            pass("network-tcp-socket-read-timeout-boundary"),
            pass("network-tcp-server-socket-bound-state"),
            pass("network-tcp-server-socket-local-socket-address"),
            pass("network-tcp-server-socket-receive-buffer"),
            pass("network-tcp-server-socket-timeout-round-trip"),
            pass("network-tcp-server-socket-accept-timeout-boundary"),
            pass("network-tcp-socket-stream-io"),
            pass("network-tcp-socket-channel-null"),
            pass("network-tcp-server-socket-channel-null"),
            pass("network-tcp-socket-explicit-connect-lifecycle"),
            pass("network-tcp-server-socket-explicit-bind-lifecycle"),
            ...
            pass("platform-thread-priority-default"),
            pass("platform-thread-priority-set-get"),
            pass("platform-thread-priority-inherited-construction"),
            ...
            pass("virtual-thread-start-inheritable-threadlocal"),
            pass("virtual-thread-builder-start-inheritable-threadlocal"),
            pass("virtual-thread-factory-new-thread-inheritable-threadlocal"),
            pass("virtual-thread-executor-submit-inheritable-threadlocal"),
