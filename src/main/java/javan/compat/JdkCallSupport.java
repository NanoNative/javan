...
public final class JdkCallSupport {
    ...
    private static final List<SupportedCall> SUPPORTED_CALLS = List.of(
        ...
        runtime("PrintStream.print", "java/io/PrintStream", "print", "(Ljava/lang/String;)V", "(C)V", "(Z)V", "(I)V", "(J)V", "(F)V", "(D)V"),
        runtime("PrintStream.println", "java/io/PrintStream", "println", "(Ljava/lang/String;)V", "(Ljava/lang/Object;)V", "(I)V", "(J)V", "(F)V", "(D)V", "(Z)V", "(C)V"),
