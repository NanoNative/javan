...
public final class JdkCallSupport {
    ...
    private static final List<SupportedCall> SUPPORTED_CALLS = List.of(
        ...
        runtime("ExecutorService.isShutdown", "java/util/concurrent/ExecutorService", "isShutdown", "()Z"),
        runtime("ExecutorService.isTerminated", "java/util/concurrent/ExecutorService", "isTerminated", "()Z"),
