...
public final class JdkCallSupport {
    ...
    private static final List<SupportedCall> SUPPORTED_CALLS = List.of(
        ...
        intrinsic("Byte.toString", "java/lang/Byte", "toString", "(B)Ljava/lang/String;"),
        ...
        intrinsic("Short.toString", "java/lang/Short", "toString", "(S)Ljava/lang/String;"),
        ...
        intrinsic("Character.toString", "java/lang/Character", "toString", "(C)Ljava/lang/String;"),
