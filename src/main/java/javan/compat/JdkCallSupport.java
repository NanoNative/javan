...
public final class JdkCallSupport {
    ...
    private static final List<SupportedCall> SUPPORTED_CALLS = List.of(
        ...
        runtime("PrintStream.print", "java/io/PrintStream", "print", "(Ljava/lang/String;)V", "(Ljava/lang/Object;)V", "(C)V", "(Z)V", "(I)V", "(J)V", "(F)V", "(D)V"),
        runtime("PrintStream.println", "java/io/PrintStream", "println", "()V", "(Ljava/lang/String;)V", "(Ljava/lang/Object;)V", "(I)V", "(J)V", "(F)V", "(D)V", "(Z)V", "(C)V"),
        ...
        runtime("StringBuilder.insert", "java/lang/StringBuilder", "insert", "(ILjava/lang/String;)Ljava/lang/StringBuilder;", "(IZ)Ljava/lang/StringBuilder;", "(IC)Ljava/lang/StringBuilder;", "(II)Ljava/lang/StringBuilder;", "(IJ)Ljava/lang/StringBuilder;", "(IF)Ljava/lang/StringBuilder;", "(ID)Ljava/lang/StringBuilder;"),
